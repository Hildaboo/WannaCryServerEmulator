...
{	
	...
	{
		$this->sockServer = socket_create(AF_INET, SOCK_STREAM, 0); // SOL_TCP
	...
	private function _bindSocket()
	{
		...
		{
			throw new SocketException(SocketException::CANT_BIND_SOCKET, socket_strerror(socket_last_error($this->sockServer)));
		}
	}
	...
	public function listen()
	{
		...
		{
			throw new SocketException(SocketException::CANT_LISTEN, socket_strerror(socket_last_error($this->sockServer)));
		}
	...
	{
		printf("WannaCry server v2.0 listening on %s:%d...\n", $this->address, $this->port);
	}
	...
	protected function serverLoop()
	{
		while($this->_listenLoop)
		{
			...
			{
				throw new SocketException(SocketException::CANT_ACCEPT, socket_strerror(socket_last_error($this->sockServer)));
				continue;
			}
